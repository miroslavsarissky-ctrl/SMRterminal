...
TYPE_RULES = [
    ...
    ('Sovereign / pension',          r'NORGES|SWISS NATIONAL|KOREA INVESTMENT CORP|TEMASEK|GIC PRIVATE|MUBADALA|'
                                     r'ABU DHABI|PUBLIC INVESTMENT FUND|CPP INVEST|CDPQ|CAISSE DE DEPOT|PSP INVEST|'
                                     r'OMERS|ONTARIO TEACHERS|HEALTHCARE OF ONTARIO|BRITISH COLUMBIA INVESTMENT|'
                                     r'ALBERTA INVESTMENT|CALPERS|CALSTRS|STATE OF WISCONSIN|STATE OF MICHIGAN|'
                                     r'STATE OF NEW JERSEY|TEACHER RETIREMENT|PUBLIC EMPLOYEES RETIREMENT|'
                                     r'SUPERANNUATION|APG ASSET|PGGM|NATIONAL PENSION|PENSION PLAN|PENSION FUND'),
    ('Passive / index',             r'VANGUARD|BLACKROCK|STATE STREET|GEODE|NORTHERN TRUST|DIMENSIONAL|'
                                    ...
                                    r'EXCHANGE TRADED CONCEPTS|FIRST TRUST|VANECK|WISDOMTREE|PROSHARES|DIREXION|'
                                    r'AMPLIFY ETF|ROUNDHILL|DEFIANCE|REX SHARES|TUTTLE|SIMPLIFY ASSET|TIDAL INVEST|'
                                    r'TOROSO|EMPOWERED FUNDS|ALPHA ARCHITECT|PACER ADVIS|INNOVATOR CAPITAL'),
    ('Hedge fund / multi-strategy', r'MILLENNIUM|CITADEL|POINT72|BALYASNY|TWO SIGMA|D\.?\s*E\.?\s*SHAW|'
                                    ...
                                    r'PENTWATER|MINT TOWER|LMR PARTNERS|TENOR CAPITAL|AQR |WATER ISLAND|'
                                    r'HUDSON BAY CAPITAL|VERITION|MAN GROUP|GSA CAPITAL|CAPSTONE INVESTMENT|'
                                    r'DAVIDSON KEMPNER|HBK |WHITEBOX|WALLEYE'),
    ('Quant / market-maker',        r'JANE STREET|SUSQUEHANNA|VIRTU|HUDSON RIVER|FLOW TRADERS|OPTIVER|IMC |'
                                    r'WOLVERINE|SIMPLEX|GTS SECURITIES|PEAK6|CTC |JUMP |TOWER RESEARCH|XTX |QUBE RESEARCH|OLD MISSION|DRW '),
    ('Broker / wealth platform',    r'BANK OF AMERICA|JPMORGAN|GOLDMAN SACHS|MORGAN STANLEY|UBS|WELLS FARGO|'
                                    ...
                                    r'BNP PARIBAS|SOCIETE GENERALE|HSBC|MACQUARIE|NOMURA|MIZUHO|DAIWA|SUMITOMO|'
                                    r'CANTOR FITZGERALD|CLEAR STREET|STONEX|OPPENHEIMER|ROBERT W\.? BAIRD|JANNEY|'
                                    r'WEDBUSH|D\.?A\.? DAVIDSON|EDWARD JONES|B\.? RILEY'),
    ('Active manager',              r'FMR|FIDELITY|T\.?\s*ROWE|PRICE T ROWE|WELLINGTON|CAPITAL RESEARCH|BAILLIE|'
                                    ...
                                    r'GABELLI|GAMCO|ROYCE|WASATCH|DRIEHAUS|BARON CAPITAL|ARTISAN PARTNERS|'
                                    r'WILLIAM BLAIR|FEDERATED HERMES|VICTORY CAPITAL|VIRTUS|THRIVENT|ALGER|'
                                    r'POLEN|WCM INVESTMENT|GQG|SANDS CAPITAL'),
]
